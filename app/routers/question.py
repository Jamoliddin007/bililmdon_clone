...
@router.post("/topics", response_model=schemas.TopicRead)
...
@router.post("/options", response_model=schemas.OptionRead)
...
@router.get("/options", response_model=List[schemas.OptionRead])
